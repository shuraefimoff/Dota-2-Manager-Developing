...
# Логическая часть выбора победившей команды
teams = {'LuckyTeam': 1, 'Napalm': 2, 'Bibisi': 3, 'Team Sincere(China)': 4, 'depressedteam': 5,
         'UFO': 6, 'Nasos': 7, 'ОУ Дядь': 8, 'Spark': 9, 'M and Ms': 10, 'Anime Squad': 11,
         'KompasGaming': 12, '0k_Gaming': 13, 'ferzee': 14, 'SeaTide': 15, 'DX': 16, 'ghoul': 17,
         'CrowCrowd': 18, 'Digital Company': 19, 'SeaOne': 20, 'Quantic.Lucky': 21, '1%': 22,
         'Quantic.Young': 23, 'KirieshkaTeam': 24, 'Sixty': 25, 'Velum': 26, 'Tidehunterdamage': 27,
         'OverKek': 28}
